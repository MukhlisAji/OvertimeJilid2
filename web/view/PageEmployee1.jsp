                        ...
                        <ul class="metismenu" id="menu1">
                            <li>
                                ...
                                <ul class="submenu-angle" aria-expanded="false">
                                    ...
                                    <li><a id="overtimes" title="overtime data" href="#"><i class="fa fa-paper-plane sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro" >Overtime</span></a></li>
                                </ul>
                            </li>
                            <li>
                            <li id="removable">
                                ...
                                <div class="form-group-inner">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 col-sm-3 col-xs-12">
                                            <label class="login2">Job Duties</label>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="footer-copy-right">
                                <p>Copyright © 2018 <a href="">Colorlib</a> Bootcamp 21. Made with LOVE</p>
                            </div>
                        </div>
                    </div>
                </div>
