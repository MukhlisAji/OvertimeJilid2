...
public class EmployeeController implements EmployeeControllerInterface {
    ...
    @Override
    public boolean insert(String nik, String name, String email, String password, String phoneNumber, String hireDate, String salary, String isAdmin, String isDelete, String isActive, String jobId, String managerId) {
         try {
            ...
            Job jobid = new Job(jobId);
            Employee managerid = new Employee(managerId);
            Employee employee = new Employee(nik, name, email, password, phoneNumber, dates, sal, isadmin, isdelete, isactive, jobid, managerid);
    ...
    @Override
    public boolean update(String nik, String name, String email, String password, String phoneNumber, String hireDate, String salary, String isAdmin, String isDelete, String isActive, String jobId, String managerId) {
        try {
            DateFormat format = new SimpleDateFormat("MM/dd/yyyy", Locale.ENGLISH);
            Date dates = format.parse(hireDate);
            int sal = Integer.parseInt(salary);
